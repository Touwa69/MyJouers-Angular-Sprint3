 ...
 */
 ...
 /*  listeJouers(): Jouer[]{
  ...
  listeJouers(): Observable<Jouer[]>{
    ...
    let httpHeaders = new HttpHeaders({"Authorization":jwt})
      return this.http.get<Jouer[]>(apiURL+"/all",{headers:httpHeaders});
    }
 ...
 /*  ajouterJouer(jouer : Jouer){
  ...
  ajouterJouer( jouer: Jouer):Observable<Jouer>{
    ...
    jwt = "Bearer "+jwt;
    let httpHeaders = new HttpHeaders({"Authorization":jwt}) 
      return this.http.post<Jouer>(apiURL+"/addjouer", jouer, {headers:httpHeaders});
    }
 ...
 /*  consulterJouer(id: number){
  ...
  consulterJouer(id: number): Observable<Jouer> {
    ...
    jwt = "Bearer "+jwt;
    let httpHeaders = new HttpHeaders({"Authorization":jwt}) 
      return this.http.get<Jouer>(url,{headers:httpHeaders});
  }
...
/*  updateJouer(j: Jouer){
  ...
  updateJouer(j : Jouer): Observable<Jouer> {
    ...
    jwt = "Bearer "+jwt;
    let httpHeaders = new HttpHeaders({"Authorization":jwt}) 
      return this.http.put<Jouer>(apiURL+"/updatejouer", j, {headers:httpHeaders});
  }
